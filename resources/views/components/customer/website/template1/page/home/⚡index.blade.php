...
<div>
    ...
    <body>
        <div>
            <div class="relative overflow-hidden">
                ...
                <section class="mx-auto mt-16 pt-24 pb-28 relative max-w-screen-2xl p-4 isolate">
                    <svg class="w-[468px] h-[788px] absolute top-0 left-0 -z-10 transform-gpu overflow-hidden blur-2xl"
                        viewBox="0 0
          468 788" fill="none" xmlns="http://www.w3.org/2000/svg"
                        id="Windframe_iSnFWlieEN">
                        ...
                        <defs>
                            <filter x="-460.404" y="-139.896" width="1067.89" height="1067.89"
                                ...
                                <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_1410_520"
                                    result="shape"></feBlend>
                            </filter>
                        </defs>
                    </svg>
                    <div class="mx-auto max-w-2xl">
                        <p class="text-center text-gray-500 font-medium tracking-wide uppercase uppercase">tailwind page
                            builder</p>
                        <p class="mt-2 text-center text-4xl md:text-6xl font-bold tracking-tight text-black">The best
                            way to organize
                            your work</p>
                        <p class="mt-6 text-lg text-gray-600 text-center">Want to receive a monthly email in your inbox
                            with awesome
                        ...
                        <div class="mt-24 w-full bg-white rounded-lg drop-shadow-xl p-2.5 flex border border-gray-300">
                            <input type="email"
                                class="border-none focus:outline-none p-2.5 flex-1 flex-shrink-0 text-lg w-full">
                            <button type="submit" style="font-family: Arial"
                                class="px-5 py-2.5 rounded-md bg-black
              text-white">Subscribe</button>
                        ...
                        <div class="items-center justify-center mt-6 flex gap-3">
                            <svg class="w-6 h-6" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg"
                                id="Windframe_VGgFAocpmbY">
                                <path d="M11.0527 22.0752C17.128 22.0752 22.0527 17.1505 22.0527 11.0752C22.0527
              4.9999 17.128 0.0751953 11.0527 0.0751953C4.97743 0.0751953 0.0527344 4.9999 0.0527344 11.0752C0.0527344
              17.1505 4.97743 22.0752 11.0527 22.0752Z" fill="currentColor"></path>
                                <path d="M5.55273 11.6251L8.85273
              14.9251L16.5527 7.2251" stroke="white" strokewidth="1.5" strokelinecap="round" strokelinejoin="round">
                                </path>
                            </svg>
                            <p class="text-center text-gray-600">It's 100% free and we will never send more than one
                                email per month</p>
                        </div>
                    </div>
                </section>
            ...
            <section class="mx-auto py-20 max-w-screen-2xl p-4">
                ...
                <div class="md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 mt-10 grid place-items-center gap-10">
                    <div class="h-10 w-auto">
                        <svg class="w-full h-full" viewBox="0 0 306 78" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_r3U9SJAgki5">
                            <path fillrule="evenodd" clip-rule="evenodd" d="M97.8958 60.9676L101.715
            ...
            39.0703V1.17529H260.259Z" fill="currentColor"></path>
                            <path d="M193.012 49.0093C191.102 52.155 187.161 54.4928
            ...
            66.5859 179.878 66.5859C185.484 66.5859 190.845 64.0645 193.012 60.417V65.6557H206.206V21.2735H193.012Z"
                                fill="currentColor"></path>
                            <path fillrule="evenodd" clip-rule="evenodd" d="M16.3399 48.9482C16.3399 53.4525
            ...
            77.4306C24.0388 77.4306 20.4035 73.7953 20.4035 69.291V48.9482Z" fill="currentColor"></path>
                            <path fillrule="evenodd" clip-rule="evenodd" d="M28.5436 16.2792C24.0393 16.2792 20.4041 12.6439 20.4041
            ...
            20.4041H28.5436Z" fill="currentColor"></path>
                            <path fillrule="evenodd" clip-rule="evenodd" d="M61.1507
            ...
            48.9474 0C53.4517 0 57.087 3.63528 57.087 8.13959V28.5436Z" fill="currentColor"></path>
                            <path fillrule="evenodd" clip-rule="evenodd" d="M48.9474 61.1514C53.4517 61.1514 57.087 64.7867 57.087 69.291C57.087 73.7953 53.4517
            ...
            57.0878H48.9474Z" fill="currentColor"></path>
                        </svg>
                    </div>
                    <div class="h-10 w-auto">
                        <svg class="w-ful h-full" viewBox="0 0 292 96" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_odKPy3RhsMV">
                            <path d="M35.9063 0H38.4989C47.4996 0.195667 56.3535 3.81551 62.7127
            ...
            25.0454C4.50177 17.9035 9.29561 11.5933 15.4591 7.19077C21.3781 2.83717 28.5688 0.440251 35.9063 0Z"
                                fill="currentColor"></path>
                            <path d="M232.063 2.54346H242.532V72.3966C239.059 72.3966 235.537 72.4455 232.063
            72.3477C232.112 49.1122 232.063 25.8278 232.063 2.54346Z" fill="currentColor"></path>
                            <path d="M94.6552
            ...
            39.1336C104.977 36.1986 100.33 34.9757 96.1227 36.0518Z" fill="currentColor"></path>
                            <path d="M146.507
            ...
            57.526C165.878 51.656 164.949 43.6336 159.959 39.0844C156.78 36.1494 152.133 34.9754 147.975 36.0515Z"
                                fill="currentColor"></path>
                            <path d="M190.484 29.5946C196.11 26.0726 203.594 25.0942 209.66 28.1271C211.567 28.9587
            ...
            200.61 35.8559Z" fill="currentColor"></path>
                            <path d="M255.103 32.0896C260.973 26.6109 270.023 24.7521 277.556
            ...
            35.6605C267.773 34.8289 262.93 37.3237 260.337 41.1392Z" fill="currentColor"></path>
                        </svg>
                    </div>
                    <div class="h-10 w-auto">
                        <svg class="w-full h-full" viewBox="0 0 295 72" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_tMIkYUTTsT6">
                            <path fillrule="evenodd" clip-rule="evenodd" d="M0 52.8024L10.5715 44.7051C16.1853
            52.0343 22.1469 55.4118 28.7901 55.4118C35.3964 55.4118 41.1942 52.0733 46.5564 44.802L57.2735
            52.7055C49.5422 63.1892 39.9234 68.728 28.7901 68.728C17.6936 68.728 7.98562 63.2281 0 52.8024Z"
                                fill="currentColor"></path>
                            <path fillrule="evenodd" clip-rule="evenodd" d="M28.7521 17.6101L9.93652
            33.8232L1.24411 23.7355L28.7895 0L56.1208 23.754L47.3855 33.8047L28.7521 17.6101Z" fill="currentColor">
                            </path>
                            <path d="M129.433 13.687H118.78V58.0744H129.433V13.687Z" fill="currentColor"></path>
                            <path fillrule="evenodd" clip-rule="evenodd" d="M97.2522 58.2708C90.9723 58.2708 85.739 56.2357 81.4942 52.1653C77.2495 48.0368
            ...
            108.242 55.7704C104.928 57.4567 101.264 58.2708 97.2522 58.2708Z" fill="currentColor"></path>
                            <path fillrule="evenodd" clip-rule="evenodd" d="M145.413 17.2386C145.413 20.4255 142.831 23.009 139.644
            23.009C136.456 23.009 133.873 20.4255 133.873 17.2386C133.873 14.0517 136.456 11.4683 139.644
            11.4683C142.831 11.4683 145.413 14.0517 145.413 17.2386ZM144.969 25.6721H134.317V58.0749H144.969V25.6721Z"
                                fill="currentColor"></path>
                            <path fillrule="evenodd" clip-rule="evenodd" d="M165.559 58.3284C160.5 58.3284 156.43
            ...
            58.3284Z" fill="currentColor"></path>
                            <path fillrule="evenodd" clip-rule="evenodd" d="M194.239
            13.687H183.587V58.0743H194.239V46.7744L195.487 45.6104L205.225 58.0743H217.618L202.656 38.925L216.869
            25.6715H203.852L194.239 34.6361V13.687Z" fill="currentColor"></path>
                            <path fillrule="evenodd" clip-rule="evenodd" d="M219.541 41.3012V13.687H230.639V40.6829C230.639 45.5092 233.451 47.835 237.519 47.835C241.527 47.835
            244.398 45.3928 244.398 40.6829V13.687H255.495V41.3012C255.495 53.9773 246.596 58.7454 237.519 58.7454C228.5
            58.7454 219.541 53.9773 219.541 41.3012Z" fill="currentColor"></path>
                            <path fillrule="evenodd" clip-rule="evenodd" d="M279.464 58.9619C288.044 58.9619 295 51.4102 295 42.0947C295 32.7792 288.044 25.2275 279.464
            ...
            49.6405C273.427 49.6405 270.152 46.2715 270.143 42.112Z" fill="currentColor"></path>
                        </svg>
                    </div>
                    <div class="h-10 w-auto">
                        <svg class="w-full h-full" viewBox="0 0 321 83" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_a6fZHYHCqV4">
                            <path d="M83.9907 62.856V0.0898438H93.732V24.8368C96.805 20.2715 101.412 17.9888
            ...
            27.1566 96.8136 29.0826C94.7678 31.0086 93.7448 33.7192 93.7448 37.2146V62.856H83.9907Z"
                                fill="currentColor"></path>
                            <path d="M170.087 57.4424C165.753 61.7766 160.305 63.9452 153.742 63.948C147.179 63.9509
            ...
            29.9392C142.182 32.6184 141.023 36.2764 141.026 40.9131C141.026 45.5526 142.185 49.2263 144.501 51.9341"
                                fill="currentColor"></path>
                            <path d="M199.166 63.9436C190.195 63.9436 185.709 59.1272 185.709
            ...
            199.166 63.9436Z" fill="currentColor"></path>
                            <path d="M218.199 82.9119C213.865 82.9119 210.282 81.7078 207.452
            ...
            11.5282 226.49 11.6669 225.702 11.6499" fill="currentColor"></path>
                            <path d="M254.793 63.9435C249.794 63.9435
            ...
            54.8699C251.945 56.1025 254.008 56.7188 256.599 56.7188Z" fill="currentColor"></path>
                            <path d="M286.953
            ...
            41.0967V62.8562H286.953Z" fill="currentColor"></path>
                            <path d="M23.0778 25.7611C30.3538 21.7207 40.3005 16.191
            40.3005 0.0810547H28.248C28.248 9.06905 23.861 11.5258 17.2227 15.2151C9.94672 19.2555 0 24.7809 0
            40.8951H12.0525C12.0525 31.9071 16.4395 29.4504 23.0778 25.7653" fill="currentColor"></path>
                            <path d="M43.9384
            ...
            22.0634L43.9384 22.0591Z" fill="currentColor"></path>
                        </svg>
                    </div>
                    <div class="h-10 w-auto">
                        <svg class="w-full h-full" viewBox="0 0 282 83" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_6tZZa94601V">
                            <path d="M189.365 80.9415H181.917C180.404 80.9415 179.244 80.1277 179.13
            ...
            75.8871H277.434V77.2854H277.434Z" fill="currentColor"></path>
                        </svg>
                    </div>
                    <div class="h-10 w-auto">
                        <svg class="w-full h-full" viewBox="0 0 326 82" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_8CUHehLuB68">
                            <path fillrule="evenodd" clip-rule="evenodd" d="M13.6987
            ...
            16.8475 67.0774 19.2354 67.0774H62.7656Z" fill="currentColor"></path>
                            <path d="M32.294 52.1057C31.6391 52.1006
            ...
            39.5168 123.702 37.3372Z" fill="currentColor"></path>
                            <path fillrule="evenodd" clip-rule="evenodd" d="M177.153
            ...
            33.9684C156.108 33.9684 153.001 41.3985 153.001 48.3512Z" fill="currentColor"></path>
                            <path d="M217.023
            ...
            65.7608 217.026 61.8269V67.0614H222.265V29.7241H217.023Z" fill="currentColor"></path>
                            <path fillrule="evenodd" clip-rule="evenodd" d="M232.131 33.6458C235.993 30.6114 241.235 28.873 246.505 28.873C254.83 28.873 259.798
            ...
            48.9566 245.116 49.5189L245.062 49.5286L243.435 49.8189C238.24 50.7814 235.603 52.0223 235.603 56.1829Z"
                                fill="currentColor"></path>
                            <path d="M290.131 30.4282C288.886 29.5414 286.925 29.0122 284.88 29.0122C282.808 29.0395
            ...
            287.039 34.539 288.349 35.1422L288.703 35.3292L290.362 30.5799L290.131 30.4282Z" fill="currentColor">
                            </path>
                            <path fillrule="evenodd" clip-rule="evenodd" d="M291.666 48.4941C291.666 36.9434 298.869 28.873 309.167
            ...
            297.377 44.6719H320.463C320.01 39.3976 316.788 33.9007 309.023 33.9007Z" fill="currentColor"></path>
                        </svg>
                    </div>
                </div>
            </section>
            <section class="mx-auto py-20 max-w-screen-2xl p-4 relative isolate overflow-hidden">
                <svg class="w-[468px] h-[788px] absolute -top-28 -right-20 -z-10 transform-gpu overflow-hidden blur-2xl"
                    viewBox="0
        0 468 788" fill="none" xmlns="http://www.w3.org/2000/svg"
                    id="Windframe_Z-60VvO9srw">
                    <circle cx="44.5105" cy="378.637" r="156.383" fill="#4A3AFF"></circle>
                    <circle cx="119.803" cy="529.24" r="156.383" fill="#702DFF"></circle>
                    <circle cx="173.364" cy="372.857" r="156.383" fill="#2D5BFF"></circle>
                    <g filter="url(#filter0_b_1410_520)">
                ...
                <p class="mt-5 text-gray-600 text-lg text-center md:max-w-xl mx-auto">Lorem ipsum dolor sit amet
                    consectetur
                ...
                <div class="md:grid-cols-2 xl:grid-cols-3 mx-auto mt-10 grid gap-10">
                    <div
                        class="rounded-xl justify-center items-center mx-auto px-10 py-24 bg-white border border-gray-300 flex
          flex-col gap-4 max-w-[30rem]">
                        <div class="w-16 h-16 bg-white rounded-full text-gray-600 p-3 border">
                            <svg class="w-full h-full" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg" id="Windframe_J3LihGVBBul">
                                <g id="Calendar / Calendar_Check">
                                    <path id="Vector" d="M4 8H20M4 8V16.8002C4
              ...
              4V2M15 12L11 16L9 14" stroke="currentColor" strokewidth="1" strokelinecap="round"
                                        strokelinejoin="round"></path>
                                </g>
                            </svg>
                        </div>
                        <p class="text-3xl font-medium text-center">Work management</p>
                        <p class="text-center text-gray-600">Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                            Perferendis
                            debitis, ex laboriosam, vel maiores neque quasi alias consectetur .</p>
                    </div>
                    <div
                        class="rounded-xl justify-center items-center mx-auto py-24 bg-white p-10 border border-gray-300 flex
          flex-col gap-4 max-w-[30rem]">
                        <div class="w-16 h-16 bg-white rounded-full text-gray-600 p-3 border">
                            <svg class="w-full h-full" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                id="Windframe_me6aCPAbO19">
          ...
          flex-col gap-4 max-w-[30rem]">
                        <div class="w-16 h-16 bg-white rounded-full text-gray-600 p-3 border">
                            <svg class="w-full h-full" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg" id="Windframe_e56x0EIKTkd">
                                ...
                                <circle cx="20" cy="12" r="2" stroke="currentColor" strokewidth="1"
                                    strokelinecap="round" strokelinejoin="round"></circle>
                                <circle cx="4" cy="12" r="2" stroke="currentColor" strokewidth="1"
                                    strokelinecap="round" strokelinejoin="round"></circle>
                                <circle cx="12" cy="20" r="2" stroke="currentColor" strokewidth="1"
                                    strokelinecap="round" strokelinejoin="round"></circle>
                                <path d="M12 6V9" stroke="currentColor" strokewidth="1" strokelinecap="round"
                                    strokelinejoin="round"></path>
                                <path d="M15 12H18" stroke="currentColor" strokewidth="1" strokelinecap="round"
                                    strokelinejoin="round"></path>
          ...
          flex-col gap-4 max-w-[30rem]">
                        <div class="w-16 h-16 bg-white rounded-full text-gray-600 p-3 border">
                            <svg fill="currentColor" class="w-full h-full" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0
              511 511"
                                id="Windframe_RDD2XodPglj">
                                <g>
                                    <path
          ...
          flex-col gap-4 max-w-[30rem]">
                        <div class="w-16 h-16 bg-white rounded-full text-gray-600 p-3 border">
                            <svg fill="currentColor" class="w-full h-full" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
                                id="Windframe_csupxVxWyTk">
                                <path
          ...
          flex-col gap-4 max-w-[30rem]">
                        <div class="w-16 h-16 bg-white rounded-full text-gray-600 p-3 border">
                            <svg fill="currentColor" class="w-full h-full" viewBox="0 0 36 36" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" id="Windframe_rqSiLtTQPtm">
                                <rect class="clr-i-outline
              clr-i-outline-path-1" x="6" y="22"
                                    width="24" height="2"></rect>
            ...
            <section class="mx-auto py-20 max-w-screen-2xl p-4">
                ...
                <div
                    class="mb-4 lg:mb-8 lg:gap-y-0 lg:flex-row lg:justify-between justify-center items-center flex flex-col gap-x-0
        gap-y-6 max-md:max-w-lg max-md:mx-auto">
                    <div class="w-full text-center lg:text-left lg:w-2/4">
                        <p
                            class="text-4xl lg:text-6xl lg:mb-6 lg:max-w-2xl lg:mx-0 font-bold tracking-tight leading-[3.25rem] mx-auto
            max-w-max">
                            Increased productivity with our product</p>
                    </div>
                    <div class="w-full text-center lg:text-left lg:w-2/4">
                        <p class="text-lg font-normal text-gray-600 mb-5">We provide all the advantages that can
                            simplify all your
                            workflows without any further requirements and make life easier</p>
                        <a href="#"
                            class="items-center justify-center text-base font-semibold text-black lg:justify-start flex flex-row
            gap-2">
                            Get Started
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg" class="" id="Windframe_sjpIH1UIcbx">
                                <path d="M7.5 15L11.0858 11.4142C11.7525 10.7475 12.0858 10.4142 12.0858
              10C12.0858 9.58579 11.7525 9.25245 11.0858 8.58579L7.5 5" stroke="currentColor" strokewidth="1"
                ...
                <div class="relative">
                    <img alt="content image"
                        ...
                        class="max-h-[540px] object-cover object-top grayscale w-full">
                    <a href="#" aria-label="Play Video"
                        class="items-center justify-center w-full h-full bg-gray-900 flex absolute
          inset-0 transition-colors duration-300 bg-opacity-50 group hover:bg-opacity-25">
                        <div
                            class="items-center justify-center w-32 h-32 bg-gray-100 rounded-full shadow-2xl flex transition
            duration-300 transform group-hover:scale-110">
                ...
                c0,0.364,0.197,0.698,0.515,0.875C7.667,17.958,7.833,18,8,18c0.184,0,0.368-0.051,0.53-0.152l8-5C16.822,12.665,17,12.345,17,12 S16.822,11.335,16.53,11.152z">
                                    </path>
                                </svg>
                            </span>
                        </div>
            ...
            <section class="bg-white text-black my-20 mx-auto max-w-screen-2xl p-6 relative isolate overflow-hidden">
                <svg class="h-[610px] w-[200px] absolute -z-10 transform-gpu overflow-hidden blur-2xl -top-32 right-0"
                    viewBox="0 0
        468 788" fill="none" xmlns="http://www.w3.org/2000/svg"
                    id="Windframe_aTyWL8nkXri">
                    <circle cx="44.5105" cy="378.637" r="156.383" fill="#4A3AFF"></circle>
                    <circle cx="119.803" cy="529.24" r="156.383" fill="#702DFF"></circle>
                    <circle cx="173.364" cy="372.857" r="156.383" fill="#2D5BFF"></circle>
                    <g filter="url(#filter0_b_1410_520)">
                ...
                <div class="lg:grid-cols-3 mt-10 mx-auto grid place-items-center gap-20 max-w-screen-2xl">
                    <div class="w-full rounded-xl shadow-lg p-12 space-y-3 border border-gray-100">
                        ...
                        <p class="text-gray-500">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolorum
                            similique magnam
                            amet</p>
                    </div>
                    <div class="w-full rounded-xl shadow-lg p-12 space-y-3 border border-gray-100">
            ...
            <section class="mx-auto py-20 px-4 max-w-screen-2xl">
                ...
                <p class="mt-2 mb-14 text-center text-4xl md:text-6xl font-bold text-black tracking-tight">Our popular
                    blogs</p>
                <div
                    class="mb-14 justify-center md:flex-wrap lg:flex-row lg:flex-nowrap lg:justify-between lg:gap-x-8 lg:gap-y-0
        flex flex-wrap gap-y-8">
                    <div
                        class="w-full rounded-2xl lg:w-1/3 group cursor-pointer border border-gray-300 p-5 transition-all
          duration-300 hover:border-black max-lg:max-w-xl">
                        ...
                        <div class="block">
                            ...
                            <p class="mb-5 text-xl font-medium leading-8 text-gray-900 line-clamp-2">Minimal is bliss
                            </p>
                            <p class="mb-10 leading-6 text-gray-500 line-clamp-2">Discover cool strategies to
          ...
          duration-300 hover:border-black max-lg:max-w-xl">
                        ...
                        <div class="block">
                            <span class="mb-3 font-medium text-black block">Jan 01, 2024</span>
                            <p class="mb-5 text-xl font-medium leading-8 text-gray-900 line-clamp-2">Effective
                                documentation</p>
                            <p class="mb-10 leading-6 text-gray-500 line-clamp-2">Learn how to use documentation to
                                improve your
                                workflow...</p>
                            <a href="#" class="text-lg font-semibold text-black cursor-pointer">Read more...</a>
                        </div>
          ...
          duration-300 hover:border-black max-lg:max-w-xl">
                        ...
                        <div class="block">
                            <span class="mb-3 font-medium text-black block">Jan 01, 2024</span>
                            <p class="mb-5 text-xl font-medium leading-8 text-gray-900 line-clamp-2">Improve your day
                                to the max</p>
                            <p class="mb-10 leading-6 text-gray-500 line-clamp-2">Explore productivity hacks and
                                conquer the world...</p>
                            <a href="#" class="text-lg font-semibold text-black cursor-pointer">Read more...</a>
                        </div>
                    </div>
                ...
                <div class="items-center justify-center flex">
                    <a href="#" class="h-fit w-fit items-center font-medium flex gap-2">
                        ...
                        <svg class="h-4 w-4" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                            id="Windframe_CS2M1CfHV04">
                            <path d="M7.5 15L11.0858 11.4142C11.7525 10.7475 12.0858 10.4142 12.0858 10C12.0858
            9.58579 11.7525 9.25245 11.0858 8.58579L7.5 5" stroke="currentColor" strokewidth="1"
                                strokelinecap="round" strokelinejoin="round"></path>
                        </svg>
                    </a>
                </div>
            ...
            <section class="bg-white py-20 sm:py-32">
                <div class="mx-auto px-4 max-w-screen-2xl relative isolate">
                    <svg class="h-[788px] w-[350px] absolute top-0 -z-10 transform-gpu overflow-hidden blur-2xl left-12"
                        viewBox="0 0
          468 788" fill="none" xmlns="http://www.w3.org/2000/svg"
                        id="Windframe_Ob5SiqOhcRY">
                        <circle cx="44.5105" cy="378.637" r="156.383" fill="#4A3AFF"></circle>
                        <circle cx="119.803" cy="529.24" r="156.383" fill="#702DFF"></circle>
                        <circle cx="173.364" cy="372.857" r="156.383" fill="#2D5BFF"></circle>
                        <g filter="url(#filter0_b_1410_520)">
                        ...
                        <defs>
                            <filter x="-460.404" y="-139.896" width="1067.89" height="1067.89"
                                ...
                                <feComposite in2="SourceAlpha" operator="in"
                                    result="effect1_backgroundBlur_1410_520"></feComposite>
                                <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_1410_520"
                                    result="shape"></feBlend>
                            </filter>
                        </defs>
                    ...
                    <div class="mx-auto lg:max-w-4xl text-center">
                        ...
                        <p class="mt-6 text-lg leading-8 text-gray-600">Quis tellus eget adipiscing convallis sit sit
                            eget aliquet quis.
                            Suspendisse eget egestas a Elementum pulvinar et feugiat blandit at. In mi viverra elit
                            nunc.</p>
                    </div>
                    <div class="mx-auto mt-16 sm:mt-20 lg:mt-24 lg:max-w-4xl">
                        <dl class="lg:max-w-none md:grid-cols-2 md:gap-y-16 grid grid-cols-1 gap-x-8 gap-y-10">
                            <div class="sm:flex-row items-center relative flex flex-col gap-6">
                                <div
                                    class="h-24 w-24 items-center justify-center rounded-full bg-white text-4xl font-bold flex border
                border-gray-500">
                                    1</div>
                                <div class="w-full flex-1 flex-shrink-0">
                                    <p class="mb-1.5 text-xs text-center sm:text-left text-black font-semibold">May
                                        2024</p>
                                    <dt class="text-xl text-center sm:text-left font-semibold leading-7 text-black">
                                        Research and
                                        Discovery</dt>
                                    <dd class="mt-2 text-base text-center sm:text-left leading-7 text-gray-500">Morbi
                                        viverra dui mi arcu sed. Tellus semper adipiscing suspendisse semper morbi. Odio
                                        urna massa nunc
                                        massa.</dd>
                                </div>
                            </div>
                ...
                border-gray-500">
                                    2</div>
                                <div class="w-full flex-1 flex-shrink-0">
                                    <p class="mb-1.5 text-xs text-center sm:text-left text-black font-semibold">Feb
                                        2024</p>
                                    <dt class="text-xl text-center sm:text-left font-semibold leading-7 text-black">
                                        Product
                                        Development</dt>
                                    <dd class="mt-2 text-center sm:text-left text-base leading-7 text-gray-500">Morbi
                                        viverra dui mi arcu sed. Tellus semper adipiscing suspendisse semper morbi. Odio
                                        urna massa nunc
                                        massa.</dd>
                                </div>
                ...
                border-gray-500">
                                    3</div>
                                <div class="w-full flex-1 flex-shrink-0">
                                    <p class="mb-1.5 text-center sm:text-left text-xs text-black font-semibold">Apr
                                        2024</p>
                                    <dt class="text-xl text-center sm:text-left font-semibold leading-7 text-black">
                                        Product Testing</dt>
                                    <dd class="mt-2 text-center sm:text-left text-base leading-7 text-gray-500">Morbi
                                        viverra dui mi arcu sed.
            ...
            <section class="mx-auto py-20 max-w-screen-2xl p-4">
                <div class="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                    <div class="mb-16">
                        ...
                        <p class="text-4xl md:text-6xl font-bold tracking-tight text-center">What our happy user says!
                        </p>
                    </div>
                    <div
                        class="md:grid-cols-2 md:gap-8 md:max-w-2xl lg:max-w-full mx-auto grid grid-cols-1 gap-5 max-w-lg">
                        <div
                            class="bg-white rounded-xl w-full mx-auto group border border-solid border-gray-300 p-6 transition-all
            duration-500 hover:border-black hover:shadow-sm">
                            <div>
                                <p
                                    class="text-base text-black leading-6 pb-8 transition-all duration-500 group-hover:text-gray-800">
                                    With
                                    their reliable and developer-friendly tools, our engineering team is freed up to
                                    focus on product and
                                    customer experiences.</p>
                            </div>
                            <div class="items-center pt-5 flex gap-5">
                                <img alt="Kate image"
                                    src="https://devwares-pull-zone.b-cdn.net/mockimages/Sophie%20Moore%20-%20Circle%20Small.png"
                                    class="object-cover h-10 w-10 rounded-full">
                                <div class="block">
                                    <p class="text-gray-900 font-medium mb-1 transition-all duration-500">Kate
                                        Henshawlee</p>
            ...
            duration-500 hover:border-black hover:shadow-sm">
                            <div>
                                <p
                                    class="text-base text-black leading-6 pb-8 transition-all duration-500
                group-hover:text-gray-800">
                                    Awesome! Just got a pro subscription and I am quite surprised to find that
                            ...
                            <div class="items-center pt-5 flex gap-5">
                                <img alt="Dave image"
                                    ...
                                    class="object-cover h-10 w-10 rounded-full">
                                <div class="block">
                                    <p class="text-gray-900 font-medium mb-1 transition-all duration-500">Dave Stevens
                                    </p>
            ...
            <section class="bg-white py-20">
                <div class="mx-auto p-4 max-w-screen-2xl relative isolate">
                    <svg class="w-[468px] h-[788px] absolute top-0 right-0 -z-10 transform-gpu overflow-hidden blur-2xl"
                        viewBox="0 0
          468 788" fill="none" xmlns="http://www.w3.org/2000/svg"
                        id="Windframe_32fGo_CC4SW">
                        <circle cx="44.5105" cy="378.637" r="156.383" fill="#4A3AFF"></circle>
                        <circle cx="119.803" cy="529.24" r="156.383" fill="#702DFF"></circle>
                        <circle cx="173.364" cy="372.857" r="156.383" fill="#2D5BFF"></circle>
                        <g filter="url(#filter0_b_1410_520)">
                    ...
                    <div class="mx-auto sm:text-center max-w-4xl">
                        ...
                        <p
                            class="mt-2 text-4xl lg:text-6xl sm:text-5xl font-bold tracking-tight text-gray-900 text-center">
                            Affordable
                            plans for you and your team</p>
                    </div>
                    <p class="mx-auto mt-6 text-lg leading-8 text-gray-600 sm:text-center max-w-2xl">Distinctio et
                        nulla eum soluta et
                        neque labore quibusdam. Saepe et quasi iusto modi velit ut non voluptas in. Explicabo id ut
                        laborum.</p>
                    <div class="mx-auto mt-20 lg:max-w-4xl lg:grid-cols-2 grid max-w-md grid-cols-1 gap-8">
                        <div
                            class="justify-between rounded-3xl bg-white shadow-xl sm:p-10 flex flex-col p-8 ring-1 ring-gray-900/10">
                            <div>
                                ...
                                <p class="mt-6 text-base leading-7 text-gray-600">Modi dolorem expedita deleniti.
                                    Corporis iste qui
                                    inventore pariatur adipisci vitae.</p>
                                <ul role="list" class="mt-10 text-sm leading-6 text-gray-600 space-y-4">
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_RU2u2PbRYAl">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                        5 products
                                    </li>
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_JAHYEV6SYsa">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_mvHJON-9uWo">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_AkxBVjp4vRs">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                            ...
                            <a href="#" aria-describedby="tier-hobby"
                                class="mt-8 rounded-md bg-black px-3.5 py-2 text-center text-sm
              font-semibold leading-6 text-white shadow-sm block hover:bg-black focus-visible:outline
              focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black">Get
                                started today</a>
                        </div>
                        <div
                            class="justify-between rounded-3xl bg-white shadow-xl sm:p-10 flex flex-col p-8 ring-1 ring-gray-900/10">
                            <div>
                                ...
                                <p class="mt-6 text-base leading-7 text-gray-600">Explicabo quo fugit vel facere ullam
                                    corrupti non dolores.
                                    Expedita eius sit sequi.</p>
                                <ul role="list" class="mt-10 text-sm leading-6 text-gray-600 space-y-4">
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_lSjH_cu5qDu">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_rkZVbPlV_nA">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_JZZpZILMDT4">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_MNgbxvT1nYF">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_ADRH8Cl0unV">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
            ...
            <section class="bg-white py-20">
                <div class="mx-auto px-4 text-center max-w-screen-2xl relative isolate">
                    <svg class="h-[788px] w-[300px] absolute left-0 -z-10 overflow-hidden blur-2xl left-20 -top-60"
                        viewBox="0 0 468
          788" fill="none" xmlns="http://www.w3.org/2000/svg"
                        id="Windframe__x8_ul9FHR2">
                        <circle cx="44.5105" cy="378.637" r="156.383" fill="#4A3AFF"></circle>
                        <circle cx="119.803" cy="529.24" r="156.383" fill="#702DFF"></circle>
                        <circle cx="173.364" cy="372.857" r="156.383" fill="#2D5BFF"></circle>
                        <g filter="url(#filter0_b_1410_520)">
                    ...
                    <div class="mx-auto max-w-2xl">
                        ...
                        <p class="mt-4 text-lg leading-8 text-gray-600">We’re a dynamic group of individuals who are
                            passionate about
                            what we do and dedicated to delivering the best results for our clients.</p>
                    </div>
                    <ul role="list"
                        class="mx-auto mt-12 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-16 grid max-w-2xl
          grid-cols-1 gap-10">
                        <li>
                            <img alt=""
                                src="https://devwares-pull-zone.b-cdn.net/mockimages/John%20Carter%20-%20Cirlce%20Small.png"
                                class="max-h-[400px] object-cover object-top mx-auto w-full rounded-lg">
                            <div class="px-8 py-6">
                                <p class="text-2xl font-semibold leading-7 tracking-tight text-black">Reeyha Gerolds
                                </p>
                                    ...
                                    <li>
                                        <a href="#" class="text-black hover:text-gray-700">
                                            ...
                                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                                aria-hidden="" id="Windframe_oJVrrq8UrV1">
                                                <path d="M11.4678 8.77491L17.2961 2H15.915L10.8543 7.88256L6.81232
                      ...
                      9.61374L15.9156 17.0075H13.7942L9.57608 10.9742V10.9738Z"></path>
                                            </svg>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="text-black hover:text-gray-700">
                                            ...
                                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                                aria-hidden="" id="Windframe_p-JAG6qoN-yr">
                                                <path fillrule="evenodd" d="M16.338
                      ...
                      19h15.34c.734 0 1.332-.582 1.332-1.299V2.298C19 1.581 18.402 1 17.668 1z" clip-rule="evenodd">
                                                </path>
                                            </svg>
                                        </a>
                                    </li>
                        ...
                        <li>
                            <img alt=""
                                ...
                                class="max-h-[400px] object-cover object-top mx-auto w-full rounded-lg">
                            <div class="px-8 py-6">
                                <p class="text-2xl font-semibold leading-7 tracking-tight text-black">Martha Crawsford
                                </p>
                                ...
                                <ul role="list" class="mt-4 justify-center flex gap-x-4">
                                    <li>
                                        <a href="#" class="text-black hover:text-gray-700">
                                            <span class="sr-only">X</span>
                                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                                aria-hidden="" id="Windframe_3_syOp8ctj3u">
                                                <path d="M11.4678 8.77491L17.2961 2H15.915L10.8543 7.88256L6.81232
                      2H2.15039L8.26263 10.8955L2.15039 18H3.53159L8.87581 11.7878L13.1444 18H17.8063L11.4675
                      8.77491H11.4678ZM9.57608 10.9738L8.95678 10.0881L4.02925 3.03974H6.15068L10.1273 8.72795L10.7466
                      9.61374L15.9156 17.0075H13.7942L9.57608 10.9742V10.9738Z"></path>
                                    ...
                                    <li>
                                        <a href="#" class="text-black hover:text-gray-700">
                                            <span class="sr-only">LinkedIn</span>
                                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                                aria-hidden="" id="Windframe_6Oaj9J57oGOC">
                                                <path fillrule="evenodd" d="M16.338
                      16.338H13.67V12.16c0-.995-.017-2.277-1.387-2.277-1.39 0-1.601 1.086-1.601
                      2.207v4.248H8.014v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.778
                      3.203 4.092v4.711zM5.005 6.575a1.548 1.548 0 11-.003-3.096 1.548 1.548 0 01.003 3.096zm-1.337
                      ...
                      19h15.34c.734 0 1.332-.582 1.332-1.299V2.298C19 1.581 18.402 1 17.668 1z" clip-rule="evenodd">
                        ...
                        <li>
                            <img alt=""
                                src="https://devwares-pull-zone.b-cdn.net/mockimages/Mike%20Warren%20-%20Circle%20Small.png"
                                class="max-h-[400px] object-cover object-top mx-auto w-full rounded-lg">
                            <div class="px-8 py-6">
                                <p class="text-2xl font-semibold leading-7 tracking-tight text-black">Michael Angelo
                                </p>
                                ...
                                <ul role="list" class="mt-4 justify-center flex gap-x-4">
                                    <li>
                                        <a href="#" class="text-black hover:text-gray-700">
                                            <span class="sr-only">X</span>
                                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                                aria-hidden="" id="Windframe_8q4gh3hEGzcO">
                                                <path d="M11.4678 8.77491L17.2961 2H15.915L10.8543 7.88256L6.81232
                      2H2.15039L8.26263 10.8955L2.15039 18H3.53159L8.87581 11.7878L13.1444 18H17.8063L11.4675
                      8.77491H11.4678ZM9.57608 10.9738L8.95678 10.0881L4.02925 3.03974H6.15068L10.1273 8.72795L10.7466
                      9.61374L15.9156 17.0075H13.7942L9.57608 10.9742V10.9738Z"></path>
                                    ...
                                    <li>
                                        <a href="#" class="text-black hover:text-gray-700">
                                            <span class="sr-only">LinkedIn</span>
                                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                                aria-hidden="" id="Windframe_Rke1CtN9J5ar">
                                                <path fillrule="evenodd" d="M16.338
                      16.338H13.67V12.16c0-.995-.017-2.277-1.387-2.277-1.39 0-1.601 1.086-1.601
                      2.207v4.248H8.014v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.778
                      3.203 4.092v4.711zM5.005 6.575a1.548 1.548 0 11-.003-3.096 1.548 1.548 0 01.003 3.096zm-1.337
            ...
            <section class="bg-white mx-auto px-4 max-w-screen-2xl">
                ...
                <div class="mx-auto max-w-4xl divide-y divide-gray-900/10">
                    <p
                        class="text-4xl font-bold leading-10 tracking-tight text-gray-900 lg:text-6xl justify-items-center">
                        Frequently
                        asked questions</p>
                    <dl class="mt-10 space-y-6 divide-y divide-gray-900/10">
                        <div class="pt-6">
                            <dt class="text-left text-base font-semibold leading-7 text-gray-900">What's the best thing
                                about
                                Switzerland?</dt>
                            <dd class="mt-2 pr-12">
                ...
                <div class="lg:grid-cols-2 grid grid-cols-1">
                    <div class="mb-10 lg:mb-0">
                        <div class="h-full w-full group">
                            <div class="h-full relative">
                                <img alt="ContactUs tailwind section"
                                    src="https://images.unsplash.com/photo-1600275669439-14e40452d20b?q=80&amp;w=2667&amp;auto=format&amp;fit=crop&amp;ixlib=rb-4.0.3&amp;ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                                    class="grayscale h-full w-full rounded-2xl lg:rounded-l-2xl lg:rounded-r-none">
                                <p class="text-4xl font-bold leading-10 text-white absolute left-11 top-11">Contact us
                                </p>
                                    ...
                                    <div class="rounded-lg bg-white block p-6">
                                        <a href="#" class="mb-6 items-center flex">
                                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                                                ...
                                                id="Windframe_YlbKIhxN_S1A">
                                                <path d="M22.3092 18.3098C22.0157 18.198 21.8689 18.1421 21.7145
                      ...
                      25.9034 19.8888C25.7076 19.6046 25.362 19.4729 24.6708 19.2096L22.3092 18.3098Z"
                                        ...
                                        <a href="#" class="mb-6 items-center flex">
                                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                                                xmlns="http://www.w3.org/2000/svg" class=""
                                                id="Windframe_YeJV0g7NcUMl">
                                                <path d="M2.81501 8.75L10.1985 13.6191C12.8358 15.2015 14.1544
                      ...
                      7.92893 2.5 10.286 2.5 15C2.5 19.714 2.5 22.0711 3.96447 23.5355C5.42893 25 7.78595 25 12.5 25Z"
                                                    stroke="currentColor" strokewidth="1" strokelinecap="round">
                                                </path>
                                            </svg>
                                            <p class="ml-5 text-base font-normal leading-6 text-black">
                                                windframe@devwares.com</p>
                                        </a>
                                        <a href="#" class="items-center flex">
                                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                                                xmlns="http://www.w3.org/2000/svg" class=""
                                                id="Windframe_TNdPtUmMxdIk">
                                                <path d="M25 12.9169C25 17.716 21.1939 21.5832 18.2779
                      ...
                      2.5C17.6522 2.5 20.1957 3.59749 22.0711 5.55105C23.9464 7.5046 25 10.1542 25 12.9169Z"
                                                    stroke="currentColor" strokewidth="1"></path>
                                                <path d="M17.5 11.6148C17.5 13.0531 16.3807 14.219 15
                      14.219C13.6193 14.219 12.5 13.0531 12.5 11.6148C12.5 10.1765 13.6193 9.01058 15 9.01058C16.3807
                      9.01058 17.5 10.1765 17.5 11.6148Z" stroke="currentColor" strokewidth="1"></path>
                                            </svg>
                                            <p class="ml-5 text-base font-normal leading-6 text-black">Silicon Valley,
                                                San Francisco Bay,
                                                California, U.S.</p>
                                        </a>
                                    </div>
                    ...
                    <div class="rounded-2xl bg-white lg:rounded-r-2xl lg:p-11 p-5">
                        ...
                        <input type="text" placeholder="Name"
                            class="border border-gray-300 placeholder-gray-400 focus:outline-none
            ...
            mb-10 h-12 w-full rounded-lg bg-transparent pl-4 text-lg font-normal leading-7 text-black shadow-sm">
                        <div class="mb-10">
                            <p class="mb-4 text-lg font-normal leading-7 text-black">Preferred method of communication
                            </p>
                            <div class="flex">
                                <div class="mr-11 items-center flex gap-2">
                                    <input type="radio" name="radio-group"
                                        class="checked:border-black checked:bg-black checked:bg-center
                  checked:bg-no-repeat"
                                        id="radio-group-1">
                                    <label for="radio-group-1"
                                        class="items-center text-base font-normal leading-6 text-black flex
            ...
            mb-10 h-12 w-full rounded-lg bg-transparent pl-4 text-lg font-normal leading-7 text-black shadow-sm">
                        <button type="submit" style="font-family: Arial"
                            class="transition-all duration-700 hover:bg-black h-12 w-full
            ...
            <section class="bg-white mx-auto py-8 px-6 max-w-screen-2xl overflow-hidden">
                <div
                    class="bg-white text-black px-6 py-20 text-center shadow-2xl sm:rounded-3xl sm:px-16 relative isolate
        overflow-hidden">
                    <svg class="w-[600px] h-[400px] absolute -z-10 overflow-hidden blur-2xl right-88 right-90 right-92 right-93 right-100 right-80"
                        viewBox="0 0 468 788" fill="none" xmlns="http://www.w3.org/2000/svg"
                        id="Windframe_7TUax8tSY2dO">
                        <circle cx="44.5105" cy="378.637" r="156.383" fill="#4A3AFF"></circle>
                        <circle cx="119.803" cy="529.24" r="156.383" fill="#702DFF"></circle>
                        <circle cx="173.364" cy="372.857" r="156.383" fill="#2D5BFF"></circle>
                        <g filter="url(#filter0_b_1410_520)">
                    ...
                    <p class="mx-auto text-4xl font-bold tracking-tight md:text-6xl max-w-4xl">The best way to organize
                        and improve
                        your work</p>
                    <p class="mx-auto mt-6 text-lg leading-8 text-gray-600 max-w-xl">Lorem ipsum dolor sit, amet
                        consectetur
                    ...
                    <div class="mt-10 items-center justify-center flex gap-x-6">
                        <a href="#"
                            class="rounded-md bg-black text-white px-3.5 py-2.5 text-sm font-semibold shadow-sm
            ...
            <footer aria-labelledby="footer-heading" class="bg-white">
                ...
                <div class="mx-auto px-4 py-20 max-w-screen-2xl">
                    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                        <div class="mt-10 xl:mt-0">
                            ...
                            <p class="mt-2 text-sm leading-6 text-gray-800">The latest news, articles, and resources,
                                sent to your inbox
                                weekly.</p>
                            <form class="mt-6 sm:flex sm:max-w-md">
                                <label for="email-address" class="sr-only">Email address</label>
                                <input type="email" placeholder="Enter your email" name="email-address"
                                    autocomplete="email" required=""
                                    class="min-w-0 appearance-none border-0 ring-1 ring-inset ring-white/10 placeholder:text-gray-500
                ...
                py-1.5 text-base text-black shadow-sm sm:w-64 sm:text-sm sm:leading-6 xl:w-full"
                                ...
                                <div class="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
                                    <button type="submit" style="font-family: Arial"
                                        class="flex hover:bg-black focus-visible:outline
                  ...
                  shadow-sm">Subscribe</button>
                            ...
                            <div class="md:grid md:grid-cols-2 md:gap-8">
                                <div>
                                    ...
                                    <ul role="list" class="mt-6 space-y-4">
                                        <li>
                                            <a href="#"
                                                class="text-sm leading-6 text-gray-800 hover:text-black">Marketing</a>
                                        </li>
                                        <li>
                                            <a href="#"
                                                class="text-sm leading-6 text-gray-800 hover:text-black">Analytics</a>
                                        </li>
                                        <li>
                                            <a href="#"
                                                class="text-sm leading-6 text-gray-800 hover:text-black">Commerce</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="mt-10 md:mt-0">
                                    ...
                                    <ul role="list" class="mt-6 space-y-4">
                                        <li>
                                            <a href="#"
                                                class="text-sm leading-6 text-gray-800 hover:text-black">Pricing</a>
                                        </li>
                                        <li>
                                            <a href="#"
                                                class="text-sm leading-6 text-gray-800 hover:text-black">Guides</a>
                                        </li>
                                        <li>
                                            <a href="#"
                                                class="text-sm leading-6 text-gray-800 hover:text-black">Mission and
                                                Values</a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="md:grid md:grid-cols-2 md:gap-8">
                                <div>
                                    ...
                                    <ul role="list" class="mt-6 space-y-4">
                                        <li>
                                            <a href="#"
                                                class="text-sm leading-6 text-gray-800 hover:text-black">About</a>
                                        </li>
                                        <li>
                                            <a href="#"
                                                class="text-sm leading-6 text-gray-800 hover:text-black">Blog</a>
                                        </li>
                                        <li>
                                            <a href="#"
                                                class="text-sm leading-6 text-gray-800 hover:text-black">Team</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="mt-10 md:mt-0">
                                    ...
                                    <ul role="list" class="mt-6 space-y-4">
                                        <li>
                                            <a href="#"
                                                class="text-sm leading-6 text-gray-800 hover:text-black">Claim</a>
                                        </li>
                                        <li>
                                            <a href="#"
                                                class="text-sm leading-6 text-gray-800 hover:text-black">Privacy</a>
                                        </li>
                                        <li>
                                            <a href="#"
                                                class="text-sm leading-6 text-gray-800 hover:text-black">Terms</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div
                        class="mt-16 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24 border-t border-white/10">
                        <div class="md:order-2 flex space-x-6">
                            <a href="#" class="text-black hover:text-gray-700">
                                <span class="sr-only">Facebook</span>
                                <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden=""
                                    id="Windframe_oBPf6stc2FBP">
                ...
                16.991 22 12z" clip-rule="evenodd"></path>
                                </svg>
                            </a>
                            <a href="#" class="text-black hover:text-gray-700">
                                <span class="sr-only">Instagram</span>
                                <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden=""
                                    id="Windframe_lex-f0apqYLI">
                ...
                5s6.255 0 7.814.418ZM15.194 12 10 15V9l5.194 3Z" clip-rule="evenodd"></path>
                                </svg>
                            </a>
                        </div>
                        <p class="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">© 2024 Windframe, Inc. All
                            rights
                            reserved.</p>
                    </div>
                </div>
            ...
            <div class="relative overflow-hidden">
                ...
                <section class="mx-auto mt-16 pt-24 pb-28 relative max-w-screen-2xl p-4 isolate">
                    <svg class="w-[468px] h-[788px] absolute top-0 left-0 -z-10 transform-gpu overflow-hidden blur-2xl"
                        viewBox="0 0
          468 788" fill="none" xmlns="http://www.w3.org/2000/svg"
                        id="Windframe_V-NHFtyMa6">
                        <circle cx="44.5105" cy="378.637" r="156.383" fill="#4A3AFF"></circle>
                        <circle cx="119.803" cy="529.24" r="156.383" fill="#702DFF"></circle>
                        <circle cx="173.364" cy="372.857" r="156.383" fill="#2D5BFF"></circle>
                        <g filter="url(#filter0_b_1410_520)">
                            <circle cx="73.5409" cy="394.049" r="393.819" fill="white"
                                fill-opacity="0.79"></circle>
                        </g>
                        <defs>
                            <filter x="-460.404" y="-139.896" width="1067.89" height="1067.89"
                                filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                    ...
                    <div class="mx-auto max-w-2xl">
                        <p class="text-center text-gray-500 font-medium tracking-wide uppercase uppercase">tailwind
                            page builder</p>
                        <p class="mt-2 text-center text-4xl md:text-6xl font-bold tracking-tight text-black">The best
                            way to organize
                            your work</p>
                        <p class="mt-6 text-lg text-gray-600 text-center">Want to receive a monthly email in your
                            inbox with awesome
                            free tips and resources on productivity? Please submit your email below.</p>
                        <div
                            class="mt-24 w-full bg-white rounded-lg drop-shadow-xl p-2.5 flex border border-gray-300">
                            <input type="email"
                                class="border-none focus:outline-none p-2.5 flex-1 flex-shrink-0 text-lg w-full">
                            <button type="submit" style="font-family: Arial"
                                class="px-5 py-2.5 rounded-md bg-black
              text-white">Subscribe</button>
                        ...
                        <div class="items-center justify-center mt-6 flex gap-3">
                            <svg class="w-6 h-6" viewBox="0 0 23 23" fill="none"
                                xmlns="http://www.w3.org/2000/svg" id="Windframe_T02Kgb7TL3L">
                                <path d="M11.0527 22.0752C17.128 22.0752 22.0527 17.1505 22.0527 11.0752C22.0527
              4.9999 17.128 0.0751953 11.0527 0.0751953C4.97743 0.0751953 0.0527344 4.9999 0.0527344 11.0752C0.0527344
              17.1505 4.97743 22.0752 11.0527 22.0752Z" fill="currentColor"></path>
                                <path d="M5.55273 11.6251L8.85273
              14.9251L16.5527 7.2251" stroke="white" strokewidth="1.5" strokelinecap="round"
                                    strokelinejoin="round"></path>
                            </svg>
                            <p class="text-center text-gray-600">It's 100% free and we will never send more than one
                                email per month</p>
            ...
            <section class="mx-auto py-20 max-w-screen-2xl p-4">
                ...
                <div class="md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 mt-10 grid place-items-center gap-10">
                    <div class="h-10 w-auto">
                        <svg class="w-full h-full" viewBox="0 0 306 78" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_OrBJdJfy6V1">
                            <path fillrule="evenodd" clip-rule="evenodd" d="M97.8958 60.9676L101.715
            52.0936C105.84 55.1781 111.335 56.7815 116.758 56.7815C120.76 56.7815 123.294 55.2393 123.294
            52.9015C123.233 46.3653 99.3157 51.4816 99.1321 35.0923C99.0709 26.7691 106.464 20.3553 116.941
            20.3553C123.171 20.3553 129.389 21.8976 133.832 25.4105L130.258 34.4681C126.195 31.8732 121.14 30.0249
            ...
            57.0878H48.9474Z" fill="currentColor"></path>
                    ...
                    <div class="h-10 w-auto">
                        <svg class="w-ful h-full" viewBox="0 0 292 96" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_xMrevm24HXv">
                            <path d="M35.9063 0H38.4989C47.4996 0.195667 56.3535 3.81551 62.7127
            10.2236C60.3647 12.6205 57.9678 14.9196 55.6687 17.3165C52.0978 14.088 47.7931 11.5933 43.0971
            10.7128C36.1509 9.24527 28.6666 10.566 22.8456 14.5283C16.4864 18.6862 12.1817 25.7302 11.2523
            33.2634C10.225 40.6988 12.3284 48.5254 17.1712 54.2976C21.8183 59.923 28.9112 63.4451 36.2487
            ...
            35.6605C267.773 34.8289 262.93 37.3237 260.337 41.1392Z" fill="currentColor"></path>
                    ...
                    <div class="h-10 w-auto">
                        <svg class="w-full h-full" viewBox="0 0 295 72" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_D8I5RsLc-4r">
                            <path fillrule="evenodd" clip-rule="evenodd" d="M0 52.8024L10.5715 44.7051C16.1853
            52.0343 22.1469 55.4118 28.7901 55.4118C35.3964 55.4118 41.1942 52.0733 46.5564 44.802L57.2735
            52.7055C49.5422 63.1892 39.9234 68.728 28.7901 68.728C17.6936 68.728 7.98562 63.2281 0 52.8024Z"
                                fill="currentColor"></path>
            ...
            49.6405C273.427 49.6405 270.152 46.2715 270.143 42.112Z" fill="currentColor"></path>
                    ...
                    <div class="h-10 w-auto">
                        <svg class="w-full h-full" viewBox="0 0 321 83" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_TAeiL2iYXU1">
                            <path d="M83.9907 62.856V0.0898438H93.732V24.8368C96.805 20.2715 101.412 17.9888
            107.552 17.9888C112.791 17.9888 116.84 19.5382 119.699 22.6369C122.558 25.7356 123.984 30.0555 123.979
            35.5967V62.856H114.246V36.9406C114.246 29.7759 111.055 26.1936 104.672 26.1936C101.479 26.1936 98.8594
            27.1566 96.8136 29.0826C94.7678 31.0086 93.7448 33.7192 93.7448 37.2146V62.856H83.9907Z"
            ...
            22.0634L43.9384 22.0591Z" fill="currentColor"></path>
                    ...
                    <div class="h-10 w-auto">
                        <svg class="w-full h-full" viewBox="0 0 282 83" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_7fYhDu9gDVz">
                            <path d="M189.365 80.9415H181.917C180.404 80.9415 179.244 80.1277 179.13
            78.6173L179.012 75.7052C173.656 80.0163 167.256 82.3397 160.507 82.3397C147.476 82.3397 142.126 74.0841
            142.126 61.5108V27.094C142.126 25.1147 143.289 24.4159 145.144 24.4159H153.294C155.157 24.4159 156.206
            24.9948 156.206 27.094V59.0654C156.206 65.468 157.834 69.8871 164.818 69.8871C169.233 69.8871 174.823
            ...
            75.8871H277.434V77.2854H277.434Z" fill="currentColor"></path>
                    ...
                    <div class="h-10 w-auto">
                        <svg class="w-full h-full" viewBox="0 0 326 82" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_0tBGjS7vDOA">
                            <path fillrule="evenodd" clip-rule="evenodd" d="M13.6987
            5.06878e-07H68.2825C70.0818 -0.000488931 71.8635 0.353474 73.526 1.04167C75.1885 1.72987 76.6991 2.73883
            77.9715 4.01091C79.244 5.283 80.2534 6.79329 80.9421 8.45554C81.6308 10.1178 81.9853 11.8994 81.9853
            13.6987V68.2784C81.9853 75.8464 75.8502 81.9812 68.2825 81.9812H13.6987C6.13257 81.979 0 75.8449 0
        ...
        0 468 788" fill="none" xmlns="http://www.w3.org/2000/svg"
                ...
                <p class="text-center text-gray-600 mb-2 font-medium tracking-wide uppercase">Features</p>
                <p class="text-4xl md:text-6xl font-bold tracking-tight text-center">Enjoy the best set of features
                </p>
                <p class="mt-5 text-gray-600 text-lg text-center md:max-w-xl mx-auto">Lorem ipsum dolor sit amet
                    consectetur
                    adipisicing elit. Minima dolore facilis modi, tempore minus et adipisci sapiente consequaturl.</p>
          ...
          flex-col gap-4 max-w-[30rem]">
                        <div class="w-16 h-16 bg-white rounded-full text-gray-600 p-3 border">
                            <svg class="w-full h-full" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg" id="Windframe_5bsQLvov2OI">
                                <g id="Calendar / Calendar_Check">
                                    <path id="Vector" d="M4 8H20M4 8V16.8002C4
              17.9203 4 18.4801 4.21799 18.9079C4.40973 19.2842 4.71547 19.5905 5.0918 19.7822C5.5192 20 6.07899 20
              7.19691 20H16.8031C17.921 20 18.48 20 18.9074 19.7822C19.2837 19.5905 19.5905 19.2842 19.7822 18.9079C20
          ...
          flex-col gap-4 max-w-[30rem]">
                        <div class="w-16 h-16 bg-white rounded-full text-gray-600 p-3 border">
                            <svg class="w-full h-full" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg" id="Windframe_wGRJNF-Q9f1">
                                <circle cx="12" cy="12" r="3" stroke="currentColor"
                                    strokewidth="1" strokelinecap="round" strokelinejoin="round"></circle>
          ...
          flex-col gap-4 max-w-[30rem]">
                        <div class="w-16 h-16 bg-white rounded-full text-gray-600 p-3 border">
                            <svg fill="currentColor" class="w-full h-full" viewBox="0 0 36 36" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" id="Windframe_0Uws6mK1jxy">
                                <rect class="clr-i-outline
              clr-i-outline-path-1" x="6" y="22"
                                    width="24" height="2"></rect>
                                <path class="clr-i-outline clr-i-outline-path-2"
        ...
        gap-y-6 max-md:max-w-lg max-md:mx-auto">
            ...
            gap-2">
                            Get Started
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg" class="" id="Windframe_WehsD1qTv-K">
                                <path d="M7.5 15L11.0858 11.4142C11.7525 10.7475 12.0858 10.4142 12.0858
              10C12.0858 9.58579 11.7525 9.25245 11.0858 8.58579L7.5 5" stroke="currentColor" strokewidth="1"
                                    strokelinecap="round" strokelinejoin="round"></path>
                            </svg>
          ...
          duration-300 hover:border-black max-lg:max-w-xl">
                        ...
                        <div class="block">
                            ...
                            <p class="mb-10 leading-6 text-gray-500 line-clamp-2">Discover cool strategies to
                                streamline and organize your
                                workflow...</p>
                            <a href="#" class="text-lg font-semibold text-black cursor-pointer">Read
                                more...</a>
                        </div>
                    </div>
                    <div
                ...
                <div class="items-center justify-center flex">
                    <a href="#" class="h-fit w-fit items-center font-medium flex gap-2">
                        ...
                        <svg class="h-4 w-4" viewBox="0 0 20 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_fHMJfPnsX4k">
                            <path d="M7.5 15L11.0858 11.4142C11.7525 10.7475 12.0858 10.4142 12.0858 10C12.0858
            9.58579 11.7525 9.25245 11.0858 8.58579L7.5 5" stroke="currentColor" strokewidth="1"
                                strokelinecap="round" strokelinejoin="round"></path>
                        </svg>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <ul role="list" class="mt-10 text-sm leading-6 text-gray-600 space-y-4">
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_m-6hZwONaMD">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_sSukZWlYNFj">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_LPrMeufG_5Z">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_1GnjDfXlVSD">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <ul role="list" class="mt-10 text-sm leading-6 text-gray-600 space-y-4">
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_GPqo2ObQB0C">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_Y8pNxtKhmIc">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_BrSusOpHxic">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_OSPWB9HxATe">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_rrH49kNQ86b">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
          ...
          grid-cols-1 gap-10">
                                ...
                                <ul role="list" class="mt-4 justify-center flex gap-x-4">
                                    <li>
                                        <a href="#" class="text-black hover:text-gray-700">
                                            <span class="sr-only">X</span>
                                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                                aria-hidden="" id="Windframe_Z2zaZt7eK71">
                                                <path d="M11.4678 8.77491L17.2961 2H15.915L10.8543 7.88256L6.81232
                      2H2.15039L8.26263 10.8955L2.15039 18H3.53159L8.87581 11.7878L13.1444 18H17.8063L11.4675
                      8.77491H11.4678ZM9.57608 10.9738L8.95678 10.0881L4.02925 3.03974H6.15068L10.1273 8.72795L10.7466
                      9.61374L15.9156 17.0075H13.7942L9.57608 10.9742V10.9738Z"></path>
                                    ...
                                    <li>
                                        <a href="#" class="text-black hover:text-gray-700">
                                            <span class="sr-only">LinkedIn</span>
                                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                                aria-hidden="" id="Windframe_sIPdl8VPCUp">
                                                <path fillrule="evenodd" d="M16.338
                      16.338H13.67V12.16c0-.995-.017-2.277-1.387-2.277-1.39 0-1.601 1.086-1.601
                      2.207v4.248H8.014v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.778
                      3.203 4.092v4.711zM5.005 6.575a1.548 1.548 0 11-.003-3.096 1.548 1.548 0 01.003 3.096zm-1.337
                                ...
                                <ul role="list" class="mt-4 justify-center flex gap-x-4">
                                    <li>
                                        <a href="#" class="text-black hover:text-gray-700">
                                            <span class="sr-only">X</span>
                                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                                aria-hidden="" id="Windframe_VFuCd2EkYI66">
                                                <path d="M11.4678 8.77491L17.2961 2H15.915L10.8543 7.88256L6.81232
                      2H2.15039L8.26263 10.8955L2.15039 18H3.53159L8.87581 11.7878L13.1444 18H17.8063L11.4675
                      8.77491H11.4678ZM9.57608 10.9738L8.95678 10.0881L4.02925 3.03974H6.15068L10.1273 8.72795L10.7466
                      9.61374L15.9156 17.0075H13.7942L9.57608 10.9742V10.9738Z"></path>
                                    ...
                                    <li>
                                        <a href="#" class="text-black hover:text-gray-700">
                                            <span class="sr-only">LinkedIn</span>
                                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                                aria-hidden="" id="Windframe_IoXVfUsCTKaM">
                                                <path fillrule="evenodd" d="M16.338
                      16.338H13.67V12.16c0-.995-.017-2.277-1.387-2.277-1.39 0-1.601 1.086-1.601
                      2.207v4.248H8.014v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.778
                      3.203 4.092v4.711zM5.005 6.575a1.548 1.548 0 11-.003-3.096 1.548 1.548 0 01.003 3.096zm-1.337
                                ...
                                <ul role="list" class="mt-4 justify-center flex gap-x-4">
                                    <li>
                                        <a href="#" class="text-black hover:text-gray-700">
                                            <span class="sr-only">X</span>
                                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                                aria-hidden="" id="Windframe_0GQzepnnZEhm">
                                                <path d="M11.4678 8.77491L17.2961 2H15.915L10.8543 7.88256L6.81232
                      2H2.15039L8.26263 10.8955L2.15039 18H3.53159L8.87581 11.7878L13.1444 18H17.8063L11.4675
                      8.77491H11.4678ZM9.57608 10.9738L8.95678 10.0881L4.02925 3.03974H6.15068L10.1273 8.72795L10.7466
                      9.61374L15.9156 17.0075H13.7942L9.57608 10.9742V10.9738Z"></path>
                                    ...
                                    <li>
                                        <a href="#" class="text-black hover:text-gray-700">
                                            <span class="sr-only">LinkedIn</span>
                                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                                aria-hidden="" id="Windframe_-FFu1MRKXbYg">
                                                <path fillrule="evenodd" d="M16.338
                      16.338H13.67V12.16c0-.995-.017-2.277-1.387-2.277-1.39 0-1.601 1.086-1.601
                      2.207v4.248H8.014v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.778
                      3.203 4.092v4.711zM5.005 6.575a1.548 1.548 0 11-.003-3.096 1.548 1.548 0 01.003 3.096zm-1.337
            ...
            <section class="bg-white mx-auto px-4 max-w-screen-2xl">
                ...
                <div class="mx-auto max-w-4xl divide-y divide-gray-900/10">
                    ...
                    <dl class="mt-10 space-y-6 divide-y divide-gray-900/10">
                        <div class="pt-6">
                            <dt class="text-left text-base font-semibold leading-7 text-gray-900">What's the best
                                thing about
                                Switzerland?</dt>
                            <dd class="mt-2 pr-12">
                                <p class="text-base leading-7 text-gray-600">I don't know, but the flag is a big plus.
                ...
                <div class="lg:grid-cols-2 grid grid-cols-1">
                    <div class="mb-10 lg:mb-0">
                      ...
                      25.9034 19.8888C25.7076 19.6046 25.362 19.4729 24.6708 19.2096L22.3092 18.3098Z"
                                            ...
                                            <p class="ml-5 text-base font-normal leading-6 text-black">123-456-7890
                                            </p>
                                        </a>
                                        <a href="#" class="mb-6 items-center flex">
                                            <svg width="30" height="30" viewBox="0 0 30 30"
                                                fill="none" xmlns="http://www.w3.org/2000/svg" class=""
                                                id="Windframe_C9-duTK-7NPi">
                                                <path d="M2.81501 8.75L10.1985 13.6191C12.8358 15.2015 14.1544
                      15.9927 15.6032 15.9582C17.0519 15.9237 18.3315 15.0707 20.8905 13.3647L27.185 8.75M12.5
                      25H17.5C22.214 25 24.5711 25 26.0355 23.5355C27.5 22.0711 27.5 19.714 27.5 15C27.5 10.286 27.5
                      7.92893 26.0355 6.46447C24.5711 5 22.214 5 17.5 5H12.5C7.78595 5 5.42893 5 3.96447 6.46447C2.5
        ...
        overflow-hidden">
                    ...
                    <p class="mx-auto text-4xl font-bold tracking-tight md:text-6xl max-w-4xl">The best way to
        ...
        <div>
          ...
          468 788" fill="none" xmlns="http://www.w3.org/2000/svg"
              ...
              text-white">Subscribe</button>
                        ...
                        <div class="items-center justify-center mt-6 flex gap-3">
                            <svg class="w-6 h-6" viewBox="0 0 23 23" fill="none"
                                xmlns="http://www.w3.org/2000/svg" id="Windframe_zQ0OeDjfiG_">
                                <path d="M11.0527 22.0752C17.128 22.0752 22.0527 17.1505 22.0527 11.0752C22.0527
              4.9999 17.128 0.0751953 11.0527 0.0751953C4.97743 0.0751953 0.0527344 4.9999 0.0527344 11.0752C0.0527344
              17.1505 4.97743 22.0752 11.0527 22.0752Z" fill="currentColor"></path>
                                <path d="M5.55273 11.6251L8.85273
            ...
            <section class="mx-auto py-20 max-w-screen-2xl p-4">
                ...
                <div class="md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 mt-10 grid place-items-center gap-10">
                    <div class="h-10 w-auto">
                        <svg class="w-full h-full" viewBox="0 0 306 78" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_P8Pnuwal8Nx">
                            <path fillrule="evenodd" clip-rule="evenodd" d="M97.8958 60.9676L101.715
            52.0936C105.84 55.1781 111.335 56.7815 116.758 56.7815C120.76 56.7815 123.294 55.2393 123.294
            52.9015C123.233 46.3653 99.3157 51.4816 99.1321 35.0923C99.0709 26.7691 106.464 20.3553 116.941
            20.3553C123.171 20.3553 129.389 21.8976 133.832 25.4105L130.258 34.4681C126.195 31.8732 121.14 30.0249
            ...
            57.0878H48.9474Z" fill="currentColor"></path>
                    ...
                    <div class="h-10 w-auto">
                        <svg class="w-ful h-full" viewBox="0 0 292 96" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_Ot0UpjNoFU3">
                            <path d="M35.9063 0H38.4989C47.4996 0.195667 56.3535 3.81551 62.7127
            10.2236C60.3647 12.6205 57.9678 14.9196 55.6687 17.3165C52.0978 14.088 47.7931 11.5933 43.0971
            10.7128C36.1509 9.24527 28.6666 10.566 22.8456 14.5283C16.4864 18.6862 12.1817 25.7302 11.2523
            33.2634C10.225 40.6988 12.3284 48.5254 17.1712 54.2976C21.8183 59.923 28.9112 63.4451 36.2487
            ...
            35.6605C267.773 34.8289 262.93 37.3237 260.337 41.1392Z" fill="currentColor"></path>
                    ...
                    <div class="h-10 w-auto">
                        <svg class="w-full h-full" viewBox="0 0 295 72" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_BMwhbD5z1cu">
                            <path fillrule="evenodd" clip-rule="evenodd" d="M0 52.8024L10.5715 44.7051C16.1853
            52.0343 22.1469 55.4118 28.7901 55.4118C35.3964 55.4118 41.1942 52.0733 46.5564 44.802L57.2735
            52.7055C49.5422 63.1892 39.9234 68.728 28.7901 68.728C17.6936 68.728 7.98562 63.2281 0 52.8024Z"
                                fill="currentColor"></path>
            ...
            49.6405C273.427 49.6405 270.152 46.2715 270.143 42.112Z" fill="currentColor"></path>
                    ...
                    <div class="h-10 w-auto">
                        <svg class="w-full h-full" viewBox="0 0 321 83" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_P0RpycQVq7C">
                            <path d="M83.9907 62.856V0.0898438H93.732V24.8368C96.805 20.2715 101.412 17.9888
            107.552 17.9888C112.791 17.9888 116.84 19.5382 119.699 22.6369C122.558 25.7356 123.984 30.0555 123.979
            35.5967V62.856H114.246V36.9406C114.246 29.7759 111.055 26.1936 104.672 26.1936C101.479 26.1936 98.8594
            27.1566 96.8136 29.0826C94.7678 31.0086 93.7448 33.7192 93.7448 37.2146V62.856H83.9907Z"
            ...
            22.0634L43.9384 22.0591Z" fill="currentColor"></path>
                    ...
                    <div class="h-10 w-auto">
                        <svg class="w-full h-full" viewBox="0 0 282 83" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_LhMDNQqqSWc">
                            <path d="M189.365 80.9415H181.917C180.404 80.9415 179.244 80.1277 179.13
            78.6173L179.012 75.7052C173.656 80.0163 167.256 82.3397 160.507 82.3397C147.476 82.3397 142.126 74.0841
            142.126 61.5108V27.094C142.126 25.1147 143.289 24.4159 145.144 24.4159H153.294C155.157 24.4159 156.206
            24.9948 156.206 27.094V59.0654C156.206 65.468 157.834 69.8871 164.818 69.8871C169.233 69.8871 174.823
            ...
            75.8871H277.434V77.2854H277.434Z" fill="currentColor"></path>
                    ...
                    <div class="h-10 w-auto">
                        <svg class="w-full h-full" viewBox="0 0 326 82" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_8mkoCOCh2bf">
                            <path fillrule="evenodd" clip-rule="evenodd" d="M13.6987
            5.06878e-07H68.2825C70.0818 -0.000488931 71.8635 0.353474 73.526 1.04167C75.1885 1.72987 76.6991 2.73883
            77.9715 4.01091C79.244 5.283 80.2534 6.79329 80.9421 8.45554C81.6308 10.1178 81.9853 11.8994 81.9853
            13.6987V68.2784C81.9853 75.8464 75.8502 81.9812 68.2825 81.9812H13.6987C6.13257 81.979 0 75.8449 0
        ...
        0 468 788" fill="none" xmlns="http://www.w3.org/2000/svg"
          ...
          flex-col gap-4 max-w-[30rem]">
                        <div class="w-16 h-16 bg-white rounded-full text-gray-600 p-3 border">
                            <svg class="w-full h-full" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg" id="Windframe_tYAcvisXCAF">
                                <g id="Calendar / Calendar_Check">
                                    <path id="Vector" d="M4 8H20M4 8V16.8002C4
              17.9203 4 18.4801 4.21799 18.9079C4.40973 19.2842 4.71547 19.5905 5.0918 19.7822C5.5192 20 6.07899 20
              7.19691 20H16.8031C17.921 20 18.48 20 18.9074 19.7822C19.2837 19.5905 19.5905 19.2842 19.7822 18.9079C20
          ...
          flex-col gap-4 max-w-[30rem]">
                        <div class="w-16 h-16 bg-white rounded-full text-gray-600 p-3 border">
                            <svg class="w-full h-full" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg" id="Windframe_bpVsPzUrw_n">
                                <circle cx="12" cy="12" r="3" stroke="currentColor"
                                    strokewidth="1" strokelinecap="round" strokelinejoin="round"></circle>
                                <circle cx="12" cy="4" r="2" stroke="currentColor"
                                    strokewidth="1" strokelinecap="round" strokelinejoin="round"></circle>
          ...
          flex-col gap-4 max-w-[30rem]">
                        <div class="w-16 h-16 bg-white rounded-full text-gray-600 p-3 border">
                            <svg fill="currentColor" class="w-full h-full" viewBox="0 0 36 36" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" id="Windframe_cMsn7cSWOM8">
                                <rect class="clr-i-outline
              clr-i-outline-path-1" x="6" y="22"
                                    width="24" height="2"></rect>
                                <path class="clr-i-outline clr-i-outline-path-2"
        ...
        gap-y-6 max-md:max-w-lg max-md:mx-auto">
            ...
            gap-2">
                            Get Started
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg" class="" id="Windframe_hvdWeMYF0HD">
                                <path d="M7.5 15L11.0858 11.4142C11.7525 10.7475 12.0858 10.4142 12.0858
              10C12.0858 9.58579 11.7525 9.25245 11.0858 8.58579L7.5 5" stroke="currentColor" strokewidth="1"
                                    strokelinecap="round" strokelinejoin="round"></path>
                            </svg>
          ...
          duration-300 hover:border-black max-lg:max-w-xl">
                ...
                <div class="items-center justify-center flex">
                    <a href="#" class="h-fit w-fit items-center font-medium flex gap-2">
                        <span>View all</span>
                        <svg class="h-4 w-4" viewBox="0 0 20 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg" id="Windframe_q7EBh5vWWl7">
                            <path d="M7.5 15L11.0858 11.4142C11.7525 10.7475 12.0858 10.4142 12.0858 10C12.0858
            9.58579 11.7525 9.25245 11.0858 8.58579L7.5 5" stroke="currentColor" strokewidth="1"
                                strokelinecap="round" strokelinejoin="round"></path>
                        </svg>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <ul role="list" class="mt-10 text-sm leading-6 text-gray-600 space-y-4">
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_kKcYz49qswe">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_0tiCqlMqJSc">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_JPZF-wJlcWK">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_yLvA8MlPe0O">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <ul role="list" class="mt-10 text-sm leading-6 text-gray-600 space-y-4">
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_QlgLoDneuSp">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_if7TAX0sj4L">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_28zagA2yOEF">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_H1jrWab7nkO">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                    ...
                                    <li class="flex gap-x-3">
                                        <svg class="h-6 w-5 text-black flex-none" viewBox="0 0 20 20"
                                            fill="currentColor" aria-hidden="" id="Windframe_l1qdwGLzsUG">
                                            <path fillrule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8
                    10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0
                    011.05-.143z" clip-rule="evenodd"></path>
                                        </svg>
                                ...
                                <ul role="list" class="mt-4 justify-center flex gap-x-4">
                                    <li>
                                        <a href="#" class="text-black hover:text-gray-700">
                                            <span class="sr-only">X</span>
                                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                                aria-hidden="" id="Windframe_fabVn7prqcx">
                                                <path d="M11.4678 8.77491L17.2961 2H15.915L10.8543 7.88256L6.81232
                      2H2.15039L8.26263 10.8955L2.15039 18H3.53159L8.87581 11.7878L13.1444 18H17.8063L11.4675
                      8.77491H11.4678ZM9.57608 10.9738L8.95678 10.0881L4.02925 3.03974H6.15068L10.1273 8.72795L10.7466
                      9.61374L15.9156 17.0075H13.7942L9.57608 10.9742V10.9738Z"></path>
                                    ...
                                    <li>
                                        <a href="#" class="text-black hover:text-gray-700">
                                            <span class="sr-only">LinkedIn</span>
                                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                                aria-hidden="" id="Windframe_VNC-U2IPIYX">
                                                <path fillrule="evenodd" d="M16.338
                      16.338H13.67V12.16c0-.995-.017-2.277-1.387-2.277-1.39 0-1.601 1.086-1.601
                      2.207v4.248H8.014v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.778
                      3.203 4.092v4.711zM5.005 6.575a1.548 1.548 0 11-.003-3.096 1.548 1.548 0 01.003 3.096zm-1.337
                                ...
                                <ul role="list" class="mt-4 justify-center flex gap-x-4">
                                    <li>
                                        <a href="#" class="text-black hover:text-gray-700">
                                            <span class="sr-only">X</span>
                                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                                aria-hidden="" id="Windframe_AlHi4lMU6y8V">
                                                <path d="M11.4678 8.77491L17.2961 2H15.915L10.8543 7.88256L6.81232
                      2H2.15039L8.26263 10.8955L2.15039 18H3.53159L8.87581 11.7878L13.1444 18H17.8063L11.4675
                      8.77491H11.4678ZM9.57608 10.9738L8.95678 10.0881L4.02925 3.03974H6.15068L10.1273 8.72795L10.7466
                      9.61374L15.9156 17.0075H13.7942L9.57608 10.9742V10.9738Z"></path>
                                    ...
                                    <li>
                                        <a href="#" class="text-black hover:text-gray-700">
                                            <span class="sr-only">LinkedIn</span>
                                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                                aria-hidden="" id="Windframe_Ve7fpzNyycoK">
                                                <path fillrule="evenodd" d="M16.338
                      16.338H13.67V12.16c0-.995-.017-2.277-1.387-2.277-1.39 0-1.601 1.086-1.601
                      2.207v4.248H8.014v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.778
                      3.203 4.092v4.711zM5.005 6.575a1.548 1.548 0 11-.003-3.096 1.548 1.548 0 01.003 3.096zm-1.337
                                ...
                                <ul role="list" class="mt-4 justify-center flex gap-x-4">
                                    <li>
                                        <a href="#" class="text-black hover:text-gray-700">
                                            <span class="sr-only">X</span>
                                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                                aria-hidden="" id="Windframe_wW09Rc4IqmFf">
                                                <path d="M11.4678 8.77491L17.2961 2H15.915L10.8543 7.88256L6.81232
                      2H2.15039L8.26263 10.8955L2.15039 18H3.53159L8.87581 11.7878L13.1444 18H17.8063L11.4675
                      8.77491H11.4678ZM9.57608 10.9738L8.95678 10.0881L4.02925 3.03974H6.15068L10.1273 8.72795L10.7466
                      9.61374L15.9156 17.0075H13.7942L9.57608 10.9742V10.9738Z"></path>
                                    ...
                                    <li>
                                        <a href="#" class="text-black hover:text-gray-700">
                                            <span class="sr-only">LinkedIn</span>
                                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                                aria-hidden="" id="Windframe_Ke-atx9wWu_4">
                                                <path fillrule="evenodd" d="M16.338
                      16.338H13.67V12.16c0-.995-.017-2.277-1.387-2.277-1.39 0-1.601 1.086-1.601
                      2.207v4.248H8.014v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.778
                      3.203 4.092v4.711zM5.005 6.575a1.548 1.548 0 11-.003-3.096 1.548 1.548 0 01.003 3.096zm-1.337
        ...
        <div class="bg-white pt-4 pr-8 pb-4 pl-8">
            <nav class="w-full">
                <div
                    class="flex w-full justify-center mt-auto mr-auto mb-auto ml-auto max-w-screen-2xl space-x-6 md:flex-row">
                    <div class="flex-row bg-white justify-between items-center mt-2 mb-2 md:m-0 hidden md:flex">
                        <a href="#" style="font-family: Raleway"
                            class="text-gray-600 text-center mr-6 font-medium
            text-base">Product</a>
                        <a href="#" style="font-family: Raleway"
                            class="text-gray-600 text-center mr-6 font-medium
            text-base">Features</a>
                        <a href="#" style="font-family: Raleway"
                            class="text-gray-600 text-center font-medium text-lg">Pricing</a>
                    </div>
                    ...
                    <div class="justify-center hidden md:flex md:justify-start items-center">
                        <a href="#" style="font-family: Raleway"
                            class="text-gray-600 text-center mr-6 font-medium text-base">About
                            Us</a>
                        <a href="#" style="font-family: Raleway"
                            class="text-gray-600 text-center mr-6 font-medium text-lg">Sign In</a>
                        <a href="#" style="font-family: Raleway"
                            class="text-gray-600 text-center font-medium text-lg">Sign Up</a>
                    </div>
                    <div class="md:hidden flex ml-auto items-center">
                        <div class="outline-none mobile-menu-button">
                            <svg id="Windframe_Ydv6wKWwIs" fill="none" strokelinecap="round"
                                strokelinejoin="round" strokewidth="2" viewBox="0 0 24 24" stroke="currentColor"
                                class="w-6 h-6 text-gray-500 hover:text-green-500">
                                <path id="Windframe_alYpjQCbJoX" d="M4 6h16M4 12h16M4 18h16"></path>
                            </svg>
                        </div>
                    </div>
                </div>
                <div class="hidden md:hidden mobile-menu">
                    <div>
                        <div class="flex flex-col">
                            <a href="#" style="font-family: Raleway"
                                class="text-gray-600 text-center mt-2 font-medium
              text-base">Product</a>
                            <a href="#" style="font-family: Raleway"
                                class="text-gray-600 text-center mt-2 font-medium
              text-base">Features</a>
              ...
              text-lg">Pricing</a>
                            <a href="#" style="font-family: Raleway"
                                class="text-gray-600 text-center mt-2 font-medium text-base">About
                                Us</a>
                            <a href="#" style="font-family: Raleway"
                                class="text-gray-600 text-center mt-2 font-medium text-lg">Sign
                                In</a>
                            <a href="#" style="font-family: Raleway"
                                class="text-gray-600 text-center mt-2 font-medium text-lg">Sign
                                Up</a>
