...
<body x-data = "mood()">
    <div x-data="{ menu: window.innerWidth > 1400, mobile: window.innerWidth <= 1400 }" x-init="window.addEventListener('resize', () => {
        menu = window.innerWidth > 1400;
        mobile = window.innerWidth <= 1400;
    })" class="flex">
        <div :class="mobile ? 'absolute z-50 w-full' : 'relative'" x-show="menu"
            class="w-72  overflow-auto   bg-box  border-r border-soft h-screen flex flex-col">
            <!-- Top / Logo -->
